...
import stormTP.operator.bolt.InfoScoreBolt;
...
public class TopologyT5 {
	...
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("InfoScoreBolt", new InfoScoreBolt().withMessageIdField("id").withTumblingWindow(new BaseWindowedBolt.Duration(15, TimeUnit.SECONDS)), nbExecutors).shuffleGrouping("GivePointsBoltBis");
        /*Affectation à la topologie du bolt qui émet le flux de sortie, il prendra en input le bolt nofilter*/
        builder.setBolt("exit", new ExitBolt(portOUTPUT, ipmOUTPUT), nbExecutors).shuffleGrouping("InfoScoreBolt");
